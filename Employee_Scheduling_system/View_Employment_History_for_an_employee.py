...
try:
    ...
    tree.heading("# 4", text="Employment History")
    ...
    #Figure out how to get a button to work in status area than you can use to display array of workers hisory with roleID
