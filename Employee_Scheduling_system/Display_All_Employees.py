# this will display list of employees in the table.
# it has feature where admin can display and update employee info,
# including changing the status to terminated or active.
...
def main():
    ...
    root.title("Display All Employee")
    ...
    """
    Enter the code to display list of the employees in table
    need to find out how to pull all employee data from database
    ......................
    ......................
    ......................
    """
