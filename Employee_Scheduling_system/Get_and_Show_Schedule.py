...
def main():
    ...
    """
    write a code to pull data from database to find employee who work and leave that day
    """
    ...
    create_button = tk.Button(root, text="View Schedule", activeforeground='white', font=("Helvetica", 12),
